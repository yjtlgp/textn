...
<div class="header">
    ...
    <div class="dl-log">欢迎您，<span class="dl-log-user">root</span><a href="admin/Public/login.html" title="退出系统" class="dl-log-quit">[退出]</a>
    </div>
</div>
<div class="content">
...
<script>
    BUI.use('main',function(){
        var config = [{id:'1',menu:[{text:'系统管理',items:[{id:'12',text:'用户管理',href:'index.php?r=user/index'},{id:'4',text:'企业管理',href:'index.php?r=role/index'}]}]},{id:'7',homePage : '9',menu:[{text:'业务管理',items:[{id:'9',text:'查询业务',href:'admin/Node/index.html'}]}]}];
